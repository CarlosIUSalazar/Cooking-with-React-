    ...
    <div className="recipe-edit">
      ...
      <div className="recipe-edit__details-grid">
        ...
        <input 
          ...
          onInput={e => handleChange({ servings : parseInt(e.target.value) || '' })} //target.value converts all to strings so will need to convert back to int with parseInt, if not possible it'll turn it into '' to avoid NaN
          className="recipe-edit__input"/>
        <label 
